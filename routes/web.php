...
Route::post('/home/logout', 'HomeController@logout')->name('home.logout');
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::delete('/product/{product}/delete', [ProductController::class, 'delete_product'])->name('delete_product');
    Route::post('/order/{order}/confirm_payment', [OrderController::class, 'confirm_payment'])->name('confirm_payment');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/order/{order}/submit_payment_receipt', [OrderController::class, 'submit_payment_receipt'])->name('submit_payment_receipt');
    Route::get('/profile', [ProfileController::class, 'show_profile'])->name('show_profile');
    Route::post('/profile', [ProfileController::class, 'edit_profile'])->name('edit_profile');
    Route::post('/profile/avatar', [ProfileController::class, 'update_avatar'])->name('update_avatar');
